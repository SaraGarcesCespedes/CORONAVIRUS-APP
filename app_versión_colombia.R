        ...
        server = function(input, output) {
                ...
                output$plot5 <- renderPlotly({
                        if(input$bar == "City"){
                                ...
                                datacolombia %>% group_by(Age) %>% 
                                        summarise(Frecuencia = n()) %>% 
                                        ggplot(aes(x = Age, y = Frecuencia)) +
                                        geom_bar(stat = "identity", fill = "aquamarine3") +  
                                        labs(x="Age", y="Frequency") + theme_bw() +
